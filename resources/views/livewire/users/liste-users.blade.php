    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500">
                    {{ $stats['total'] }} utilisateur(s) · {{ $stats['admins'] }} admin · {{ $stats['admin_stocks'] }} admin stock · {{ $stats['agents'] }} agent · {{ $stats['clients'] }} client · {{ $stats['direction_production'] }} prod.
                </p>
            </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm text-gray-500">Admin Stock</p>
                        <p class="text-2xl font-bold text-indigo-600">{{ $stats['admin_stocks'] }}</p>
                    </div>
                    ...
                    <div>
                        ...
                        <livewire:components.searchable-select
                            ...
                            :options="[
                                ...
                                ['value' => 'direction_production', 'text' => 'Direction production'],
                            ]"
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium 
                                        {{ $user->hasRole('admin') ? 'bg-purple-100 text-purple-800' : ($user->hasRole('admin_stock') ? 'bg-indigo-100 text-indigo-800' : ($user->hasRole('agent') ? 'bg-blue-100 text-blue-800' : ($user->hasRole('client') ? 'bg-emerald-100 text-emerald-800' : ($user->hasRole('direction_production') ? 'bg-amber-100 text-amber-800' : 'bg-gray-100 text-gray-800')))) }}">
                                        {{ $user->role_name }}
                                    </span>
                                </td>
