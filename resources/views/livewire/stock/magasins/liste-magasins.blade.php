    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">{{ $usage === 'appro' ? 'Magasins (approvisionnement)' : 'Magasins (commandes / cartes)' }}</h1>
                    <p class="text-gray-500 mt-1">{{ $usage === 'appro' ? 'Magasins pour demandes d\'approvisionnement' : 'Magasins pour commandes et cartes clients' }}</p>
                </div>
                <a href="{{ $usage === 'appro' ? route('stock.magasins-appro.create') : route('stock.magasins.create') }}" 
                    ...
                    @forelse($magasins as $magasin)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <a href="{{ $usage === 'appro' ? route('stock.magasins-appro.edit', $magasin->id) : route('stock.magasins.edit', $magasin->id) }}" 
