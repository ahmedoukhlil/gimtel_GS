    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">{{ $usage === 'appro' ? 'Catégories (approvisionnement)' : 'Catégories (commandes / cartes)' }}</h1>
                    <p class="text-gray-500 mt-1">{{ $usage === 'appro' ? 'Catégories pour demandes d\'approvisionnement' : 'Catégories pour commandes et cartes clients' }}</p>
                </div>
                <a href="{{ $usage === 'appro' ? route('stock.categories-appro.create') : route('stock.categories.create') }}" 
                    ...
                    @forelse($categories as $categorie)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <a href="{{ $usage === 'appro' ? route('stock.categories-appro.edit', $categorie->id) : route('stock.categories.edit', $categorie->id) }}" class="text-blue-600 hover:text-blue-900 mr-3">Modifier</a>
                                <button wire:click="confirmDelete({{ $categorie->id }})" class="text-red-600 hover:text-red-900">Supprimer</button>
                            </td>
                        </tr>
                    @empty
                        <tr>
